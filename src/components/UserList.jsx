...
function UserList() {
  ...
  const { omcn1, omcn2, omcn3, omcn4, omcn5, omcn6 } = useSelector(
    (state) => state.users
  );
      ...
      >
        <thead>
          <tr
            ...
            style={{ fontSize: "15px", backgroundColor: "rgb(224, 145, 255)" }}
          >
            <th>No</th>
            <th>Codigo</th>
          ...
          {omcn1.length > 0 ? (
            omcn1.map((lista, index) => (
              <tr
                ...
                id={lista.idOmc23N1}
                className="row-omcN1"
                onClick={() => selectOpp(lista.idOmc23N1)}
        ...
        <table className="table table-striped table-hover mt-5 shadow-lg">
          <thead>
            <tr
              style={{
                fontSize: "15px",
                backgroundColor: "rgb(224, 145, 255)",
              }}
              className="text-white"
            >
              <th>No</th>
            ...
            {dataomcn2.length > 0 ? (
              dataomcn2.map((lista, index) => (
                <tr
                  ...
                  id={lista.idOmc23N2}
                  className="row-omcN1"
                  onClick={() => selectOpp2(lista.idOmc23N2)}
                  style={{ fontSize: "14px" }}
                >
            ...
            {dataomcn3.length > 0 ? (
              dataomcn3.map((lista, index) => (
                <tr
                  ...
                  id={lista.idOmc23N3}
                  className="row-omcN1"
                  onClick={() => selectOpp3(lista.idOmc23N3)}
                  style={{ fontSize: "14px" }}
                >
            ...
            {dataomcn4.length > 0 ? (
              dataomcn4.map((lista, index) => (
                <tr
                  ...
                  id={lista.idOmc23N4}
                  className="row-omcN1"
                  onClick={() => selectOpp4(lista.idOmc23N4)}
                  style={{ fontSize: "14px" }}
                >
            ...
            {dataomcn5.length > 0 ? (
              dataomcn5.map((lista, index) => (
                <tr
                  ...
                  id={lista.idOmc23N5}
                  className="row-omcN1"
                  onClick={() => selectOpp5(lista.idOmc23N5)}
                  style={{ fontSize: "14px" }}
                >
