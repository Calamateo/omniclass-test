...
export default function ModalEdid(props) {
  ...
  const onSubmit = (data, e) => {
    if (e.target.regFinal) {
      console.log(e.target.regFinal.checked);
    }
    ...
    <Fragment>
      <div className="overlay">
        <div className="modalContainer">
          <button className="closeBtn" onClick={() => props.setactive(false)}>
            X
          </button>
          <div className="headerTittle">
            {" "}
            Editar concepto de la norma Omniclass 23: Productos Nivel{" "}
            {props.numeroTabla}
          </div>
              ...
              <div className="row InputAdd">
                <div className="form-group mt-sm-2 col-md-6">
                  ...
                  <input
                    ...
                    id="inputEmail4"
                    {...register("Codigo", { required: true, minLength: 15 })}
                    placeholder="Código"
                  />
                  {errors.Codigo && (
              ...
              <div className="row mt-2 InputAdd">
                <div className="form-group mt-2 col-md-6 col-sm-12">
                  <textarea
                    ...
                    {...register("ejemploEng", { maxLength: 300 })}
                    rows="3"
                  ></textarea>
                  {errors.ejemploEng && (
                    <span className="text-danger text-small d-block mb-2">
                ...
                <div className="form-group mt-2 col-md-6 col-sm-12">
                  <textarea
                    ...
                    id="exampleFormControlTextarea1"
                    maxLength="400"
                    placeholder="Ejemplo en Español"
                    {...register("ejemploSpa", { maxLength: 400 })}
                    rows="3"
                  ></textarea>
                  {errors.ejemploSpa && (
                    <span className="text-danger text-small d-block mb-2">
              ...
              <div className="d-flex align-items-end flex-column">
                <div>
                  ...
                  <button
                    ...
                    className="btn m-2 btn-danger mt-3"
                  >
                    Cancelar
                  </button>
                </div>
