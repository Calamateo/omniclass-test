...
const FormOmc34 = (props) => {
  ...
  return (
    <div className="containerOmc34Form shadow-lg">
      <div className="headerOmc34Form">
        Registrar Nuevo Rol Organizacional
        <button
          className="closeBtnFormOmc34"
          onClick={() => props.setformhiden(false)}
        >
          X
        </button>
      </div>
      <form className="row formOmc34" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-3 col-sm-12 col-md-4">
          ...
          <input
            ...
            className="form-control"
            id="exampleInputEmail1"
            {...register("descriEng", { required: true })}
            aria-describedby="emailHelp"
          />
          {errors.descriEng && (
            <span className="text-danger text-small d-block mb-2">
        ...
        <div className="mb-3 col-sm-12 col-md-4">
          ...
          <input
            ...
            className="form-control"
            id="exampleInputEmail1"
            {...register("descriSpa", { required: true })}
            aria-describedby="emailHelp"
          />
          {errors.descriSpa && (
            <span className="text-danger text-small d-block mb-2">
        ...
        <div class="col-sm-12 mb-3 col-md-4">
          ...
          <textarea
            class="form-control textAreaFormOmc34"
            {...register("definicionEng", { required: true })}
            id="floatingTextarea"
          ></textarea>
        ...
        <div class=" col-sm-12 mb-3 col-md-4">
          ...
          <textarea
            class="form-control textAreaFormOmc34"
            {...register("definicionSpa", { required: true })}
            id="floatingTextarea"
          ></textarea>
        ...
        <div className="mb-3 col-sm-12 col-md-4">
          <div className="mb-3 col-sm-12 col-md-12">
            ...
            <input
              type="text"
              className="form-control"
              {...register("fuenteInf", { required: true })}
              id="exampleInputEmail1"
              aria-describedby="emailHelp"
            />
            {errors.fuenteInf && (
          ...
          <div className="mb-3 col-sm-12 col-md-12">
            <label htmlFor="exampleInputEmail1" className="form-label">
              Año de alta del registro
            </label>
            <input
              type="date"
              className="form-control"
              {...register("fecRegIng", { required: true })}
              id="exampleInputEmail1"
              aria-describedby="emailHelp"
            />
            {errors.fecRegInf && (
      ...
      <div className="footerOmc34Form">consulting&construction</div>
    </div>
  );
};
