...
function PageConsultaOrg() {
  ...
  return (
    <Fragment>
      ...
      />
      <div
        className="container containerOmc34RolOrg"
        style={{ marginTop: "100px" }}
      >
        {/* <TablaOmc34 datamap={datamap} nextNivel={nextNivel}  nivel={numLevel}/>    */}
        <NavLink className="btnConsultarRolOrg" to="/rolesOrganizacionales">
          {" "}
          <BsArrowBarLeft />
          Regresar
        </NavLink>
        <div className="containerTitle">
          <p className="textTitle">
            ...
            <p style={{ fontZise: "" }}>Consulta Roles Organizacionales</p>
          </p>
          ...
          <div className="containerListaConsultaOmc34">
            {omc34n1.map((omc34N1) => (
              <ul className={`item${omc34N1.Codigo}`} key={omc34N1.Codigo}>
                <li
                  className={`listaConsultaItemOmc34`}
                  onClick={(e) => Colapsar(e)}
                >
                  <AiFillCaretDown />
                  {omc34N1.Codigo}| {omc34N1.Codigo} | {omc34N1.Codigo}|{" "}
                  {omc34N1.Codigo} | {omc34N1.Codigo} | {omc34N1.Codigo} |{" "}
                  {omc34N1.Codigo}{" "}
                </li>
                {nivel2 === true ? (
                      ...
                      <ul>
                        ...
                        {nivel4 === true ? (
                          <ul onClick={(e) => Colapsar(e)}>
                            ...
                            {nivel5 === true ? (
                              <ul>
                                <li className="listaConsultaItemOmc34">
                                  Nivel 5
                                </li>
                              </ul>
                            ) : null}
