  ...
  const updateRegistro = (data) => {
    ...
    switch (numeroTabla) {
      ...
      case 2:
        ...
        UpdateOmc23Url(
          numeroTabla,
          idRegistro2[0].idOmc23N2,
          data,
          idRegistro2[0].fk_Omc23N1
        );
        break;
      case 3:
        ...
        UpdateOmc23Url(
          numeroTabla,
          idRegistro3[0].idOmc23N3,
          data,
          idRegistro3[0].fk_Omc23N2
        );
        break;
      case 4:
        ...
        UpdateOmc23Url(
          numeroTabla,
          idRegistro4[0].idOmc23N4,
          data,
          idRegistro4[0].fk_Omc23N3
        );
        break;
      case 5:
        ...
        UpdateOmc23Url(
          numeroTabla,
          idRegistro5[0].idOmc23N5,
          data,
          idRegistro5[0].fk_Omc23N4
        );
        break;
      case 6:
        ...
        UpdateOmc23Url(
          numeroTabla,
          idRegistro6[0].idOmc23N6,
          data,
          idRegistro6[0].fk_Omc23N5
        );
        break;
      default:
        break;
