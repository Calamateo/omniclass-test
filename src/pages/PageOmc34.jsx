  ...
  const updateRegistro = (data) => {
    ...
    switch (numeroTabla) {
      ...
      case 2:
        ...
        const idRegistro2 = omc34n2.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc34Url(
          numeroTabla,
          idRegistro2[0].idOmc34N2,
          data,
          idRegistro2[0].fk_Omc34N1
        );
        break;
      case 3:
        const idRegistro3 = omc34n3.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc34Url(
          numeroTabla,
          idRegistro3[0].idOmc34N3,
          data,
          idRegistro3[0].fk_Omc34N2
        );
        break;
      case 4:
        const idRegistro4 = omc34n4.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc34Url(
          numeroTabla,
          idRegistro4[0].idOmc34N4,
          data,
          idRegistro4[0].fk_Omc34N3
        );
        break;
      default:
        break;
      ...
      <div className="container marginDivTable" style={{}}>
        ...
        <div className="containerTitle">
          <p className="textTitle">
            Norma Omniclass 34: Roles Organizacionales
          </p>
        ...
        {dataomcn4.length > 0 ? (
          <Omcn4 dataomcn4={dataomcn4} edidrow={edidrow} />
        ) : null}
        <ModalEdid
          current={current}
