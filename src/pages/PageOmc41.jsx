  ...
  const updateRegistro = (data) => {
    ...
    switch (numeroTabla) {
      ...
      case 2:
        ...
        const idRegistro2 = omc41n2.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc41Url(
          numeroTabla,
          idRegistro2[0].idOmc41N2,
          data,
          idRegistro2[0].fk_Omc41N1
        );
        break;
      case 3:
        const idRegistro3 = omc41n3.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc41Url(
          numeroTabla,
          idRegistro3[0].idOmc41N3,
          data,
          idRegistro3[0].fk_Omc41N2
        );
        break;
      case 4:
        const idRegistro4 = omc41n4.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc41Url(
          numeroTabla,
          idRegistro4[0].idOmc41N4,
          data,
          idRegistro4[0].fk_Omc41N3
        );
        break;
      case 5:
        const idRegistro5 = omc41n5.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc41Url(
          numeroTabla,
          idRegistro5[0].idOmc41N5,
          data,
          idRegistro5[0].fk_Omc41N4
        );
        break;
      case 6:
        const idRegistro6 = omc41n6.filter((reg) => reg.Codigo === data.Codigo);
        UpdateOmc41Url(
          numeroTabla,
          idRegistro6[0].idOmc41N6,
          data,
          idRegistro6[0].fk_Omc41N5
        );
        break;
      default:
        break;
  ...
  return (
    <Fragment>
      <div className="container marginDivTable" style={{}}>
        ...
        {dataomcn6.length > 0 ? (
          <Omcn6 dataomcn6={dataomcn6} edidrow={edidrow} />
        ) : null}
        <ModalEdid
          current={current}
